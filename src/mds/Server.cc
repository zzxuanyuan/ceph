...
void Server::create_logger()
{
  ...
  plb.add_u64_counter(l_mdss_handle_client_request,"handle_client_request", "hcr");
  plb.add_u64_counter(l_mdss_handle_slave_request, "handle_slave_request", "hsr");
  plb.add_u64_counter(l_mdss_handle_client_session, "handle_client_session", "hcs");
