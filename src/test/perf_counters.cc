...
TEST(PerfCounters, MultiplePerfCounters) {
  ...
  ASSERT_EQ(sd("{\"test_perfcounter_1\":{\"element1\":{\"type\":2,\"description\":\"NO_INFO_FIX\",\"nick\":\"\"},"
	    "\"element2\":{\"type\":1,\"description\":\"NO_INFO_FIX\",\"nick\":\"\"},\"element3\":{\"type\":5,\"description\":\"NO_INFO_FIX\",\"nick\":\"\"}}}"), msg);
  coll->clear();
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ("{}", msg);
}
