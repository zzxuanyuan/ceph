...
void CEPH_EXPORT rbd_version(int *major, int *minor, int *extra);

/* images */
int CEPH_EXPORT rbd_list(rados_ioctx_t io, char *names, size_t *size);
int CEPH_EXPORT rbd_create(rados_ioctx_t io, const char *name, uint64_t size, int *order);
int CEPH_EXPORT rbd_create2(rados_ioctx_t io, const char *name, uint64_t size,
 ...
 */
int CEPH_EXPORT rbd_create3(rados_ioctx_t io, const char *name, uint64_t size,
		uint64_t features, int *order,
		uint64_t stripe_unit, uint64_t stripe_count);
int CEPH_EXPORT rbd_clone(rados_ioctx_t p_ioctx, const char *p_name,
	      const char *p_snapname, rados_ioctx_t c_ioctx,
	      const char *c_name, uint64_t features, int *c_order);
int CEPH_EXPORT rbd_clone2(rados_ioctx_t p_ioctx, const char *p_name,
	       const char *p_snapname, rados_ioctx_t c_ioctx,
	       const char *c_name, uint64_t features, int *c_order,
	       uint64_t stripe_unit, int stripe_count);
int CEPH_EXPORT rbd_remove(rados_ioctx_t io, const char *name);
int CEPH_EXPORT rbd_remove_with_progress(rados_ioctx_t io, const char *name,
			     librbd_progress_fn_t cb, void *cbdata);
int CEPH_EXPORT rbd_rename(rados_ioctx_t src_io_ctx, const char *srcname, const char *destname);

int CEPH_EXPORT rbd_open(rados_ioctx_t io, const char *name, rbd_image_t *image, const char *snap_name);
 ...
 */
int CEPH_EXPORT rbd_open_read_only(rados_ioctx_t io, const char *name, rbd_image_t *image,
		       const char *snap_name);
int CEPH_EXPORT rbd_close(rbd_image_t image);
int CEPH_EXPORT rbd_resize(rbd_image_t image, uint64_t size);
int CEPH_EXPORT rbd_resize_with_progress(rbd_image_t image, uint64_t size,
			     librbd_progress_fn_t cb, void *cbdata);
int CEPH_EXPORT rbd_stat(rbd_image_t image, rbd_image_info_t *info, size_t infosize);
int CEPH_EXPORT rbd_get_old_format(rbd_image_t image, uint8_t *old);
int CEPH_EXPORT rbd_get_size(rbd_image_t image, uint64_t *size);
int CEPH_EXPORT rbd_get_features(rbd_image_t image, uint64_t *features);
int CEPH_EXPORT rbd_get_stripe_unit(rbd_image_t image, uint64_t *stripe_unit);
int CEPH_EXPORT rbd_get_stripe_count(rbd_image_t image, uint64_t *stripe_count);
int CEPH_EXPORT rbd_get_overlap(rbd_image_t image, uint64_t *overlap);
int CEPH_EXPORT rbd_get_parent_info(rbd_image_t image,
			char *parent_poolname, size_t ppoolnamelen,
			char *parent_name, size_t pnamelen,
			char *parent_snapname, size_t psnapnamelen);
int CEPH_EXPORT rbd_copy(rbd_image_t image, rados_ioctx_t dest_io_ctx, const char *destname);
int CEPH_EXPORT rbd_copy2(rbd_image_t src, rbd_image_t dest);
int CEPH_EXPORT rbd_copy_with_progress(rbd_image_t image, rados_ioctx_t dest_p, const char *destname,
			   librbd_progress_fn_t cb, void *cbdata);
int CEPH_EXPORT rbd_copy_with_progress2(rbd_image_t src, rbd_image_t dest,
			   librbd_progress_fn_t cb, void *cbdata);

/* snapshots */
int CEPH_EXPORT rbd_snap_list(rbd_image_t image, rbd_snap_info_t *snaps, int *max_snaps);
void CEPH_EXPORT rbd_snap_list_end(rbd_snap_info_t *snaps);
int CEPH_EXPORT rbd_snap_create(rbd_image_t image, const char *snapname);
int CEPH_EXPORT rbd_snap_remove(rbd_image_t image, const char *snapname);
int CEPH_EXPORT rbd_snap_rollback(rbd_image_t image, const char *snapname);
int CEPH_EXPORT rbd_snap_rollback_with_progress(rbd_image_t image, const char *snapname,
				    librbd_progress_fn_t cb, void *cbdata);
/**
 ...
 */
int CEPH_EXPORT rbd_snap_protect(rbd_image_t image, const char *snap_name);
/**
 ...
 */
int CEPH_EXPORT rbd_snap_unprotect(rbd_image_t image, const char *snap_name);
/**
 ...
 * @returns 0 on success, negative error code on failure
 */
int CEPH_EXPORT rbd_snap_is_protected(rbd_image_t image, const char *snap_name,
			  int *is_protected);
int CEPH_EXPORT rbd_snap_set(rbd_image_t image, const char *snapname);

int CEPH_EXPORT rbd_flatten(rbd_image_t image);
 ...
 */
ssize_t CEPH_EXPORT rbd_list_children(rbd_image_t image, char *pools, size_t *pools_len,
 ...
 */
ssize_t CEPH_EXPORT rbd_list_lockers(rbd_image_t image, int *exclusive,
 ...
 */
int CEPH_EXPORT rbd_lock_exclusive(rbd_image_t image, const char *cookie);
 ...
 * @returns -EEXIST if the lock is already held by the same (client, cookie) pair
 */
int CEPH_EXPORT rbd_lock_shared(rbd_image_t image, const char *cookie, const char *tag);
 ...
 */
int CEPH_EXPORT rbd_unlock(rbd_image_t image, const char *cookie);
 ...
 * @returns -ENOENT if the lock is not held by the specified (client, cookie) pair
 */
int CEPH_EXPORT rbd_break_lock(rbd_image_t image, const char *client, const char *cookie);
...
ssize_t CEPH_EXPORT rbd_read(rbd_image_t image, uint64_t ofs, size_t len, char *buf);

/* DEPRECATED; use rbd_read_iterate2 */
int64_t CEPH_EXPORT rbd_read_iterate(rbd_image_t image, uint64_t ofs, size_t len,
 ...
 */
int CEPH_EXPORT rbd_read_iterate2(rbd_image_t image, uint64_t ofs, uint64_t len,
		      int (*cb)(uint64_t, size_t, const char *, void *), void *arg);
/**
 ...
 */
int CEPH_EXPORT rbd_diff_iterate(rbd_image_t image,
		     const char *fromsnapname,
		     uint64_t ofs, uint64_t len,
		     int (*cb)(uint64_t, size_t, int, void *), void *arg);
ssize_t CEPH_EXPORT rbd_write(rbd_image_t image, uint64_t ofs, size_t len, const char *buf);
int CEPH_EXPORT rbd_discard(rbd_image_t image, uint64_t ofs, uint64_t len);
int CEPH_EXPORT rbd_aio_write(rbd_image_t image, uint64_t off, size_t len, const char *buf, rbd_completion_t c);
int CEPH_EXPORT rbd_aio_read(rbd_image_t image, uint64_t off, size_t len, char *buf, rbd_completion_t c);
int CEPH_EXPORT rbd_aio_discard(rbd_image_t image, uint64_t off, uint64_t len, rbd_completion_t c);
int CEPH_EXPORT rbd_aio_create_completion(void *cb_arg, rbd_callback_t complete_cb, rbd_completion_t *c);
int CEPH_EXPORT rbd_aio_is_complete(rbd_completion_t c);
int CEPH_EXPORT rbd_aio_wait_for_complete(rbd_completion_t c);
ssize_t CEPH_EXPORT rbd_aio_get_return_value(rbd_completion_t c);
void CEPH_EXPORT rbd_aio_release(rbd_completion_t c);
int CEPH_EXPORT rbd_flush(rbd_image_t image);
/**
 ...
 * @returns 0 on success, negative error code on failure
 */
int CEPH_EXPORT rbd_aio_flush(rbd_image_t image, rbd_completion_t c);
